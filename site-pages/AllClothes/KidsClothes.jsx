  ...
  return (
    <div className="min-h-screen bg-dark-gray-custom py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Reviews Section */}
        <div className="bg-black-custom rounded-xl shadow-lg p-4 sm:p-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
            <h2 className="text-2xl font-bold text-metallic-silver">
              Customer Reviews
            </h2>
            <div className="flex items-center gap-6 sm:gap-8">
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-dark-gray-custom0 font-medium">
                  Average Rating
                </div>
              </div>
              <div className="w-px h-10 bg-dark-gold/40"></div>
              <div className="text-center">
          ...
          {reviewsLoading ? (
            <div className="flex justify-center py-12">
              <div className="text-center">
                <div className="w-16 h-16 border-4 border-dark-gold/40 border-t-dark-gray-custom0 border-r-dark-gray-custom0 rounded-full animate-spin mb-4"></div>
              ...
              {reviews.length > 0 ? (
                <div className="space-y-6">
                  {reviews.map((review, index) => (
                    <div
                      key={review._id}
                      className="border border-dark-gray-custom rounded-2xl p-4 sm:p-6 bg-linear-to-br from-white to-dark-gray-custom/50 hover:shadow-xl transition-all duration-300 hover:border-dark-gold/40 relative overflow-hidden group"
                    >
                      {/* Review Header */}
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-3">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-gold to-gold rounded-full flex items-center justify-center text-white font-bold shadow-md text-sm sm:text-base">
                              {review.userName?.charAt(0)?.toUpperCase() || "U"}
                            </div>
                            <div>
                              <h4 className="text-base sm:text-lg font-bold text-metallic-silver leading-tight">
                                {review.userName}
                              </h4>
                              <div className="flex items-center gap-1.5 mt-0.5">
                                <span className="w-1.5 h-1.5 bg-dark-gray-custom0 rounded-full"></span>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="ml-1 sm:ml-2 px-2 py-0.5 bg-dark-gray-custom text-dark-gold rounded-full text-xs sm:text-sm font-bold">
                              {review.rating}.0
                            </span>
                          </div>
                        </div>
                      ...
                      {/* Review Content */}
                      <div className="relative pl-4 border-l-2 sm:border-l-4 border-dark-gray-custom0/30 group-hover:border-dark-gray-custom0 transition-colors duration-300">
                      ...
                      {/* Review Index Badge */}
                      <div className="absolute -top-1 -right-1 w-12 h-12 bg-dark-gray-custom flex items-center justify-center rounded-bl-3xl text-dark-gold/40 text-xl font-black group-hover:text-dark-gray-custom transition-colors duration-300 z-0">
                        {index + 1}
                      </div>
                    </div>
                  ))}
                ...
                <div className="text-center py-16">
                  <div className="w-32 h-32 bg-dark-gray-custom rounded-full flex items-center justify-center mx-auto mb-6 relative">
                    <div className="absolute inset-0 bg-linear-to-br from-dark-gray-custom/60 to-blue-100 rounded-full animate-pulse"></div>
                    <span className="text-6xl text-light-silver relative z-10">
                      <FaRegStar />
                    </span>
                  </div>
                  <h3 className="text-2xl font-bold text-metallic-silver mb-3">
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-linear-to-r from-gold to-dark-gold text-white rounded-lg hover:from-dark-gold hover:to-dark-gold font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200"
                  >
...
export default KidsClothesDetails;
