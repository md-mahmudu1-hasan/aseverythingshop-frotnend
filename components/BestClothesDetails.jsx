            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-dark-gold/30 text-gold px-3 py-1 rounded-full text-sm font-medium border border-dark-gold">
                ...
                {isFreeDelivery(clothesdetails) && (
                  <span className="rounded-full border border-gold/60 bg-gold/10 px-3 py-1 text-sm font-medium text-gold">
                    Free delivery
                  </span>
                )}
                {!isFreeDelivery(clothesdetails) && (
                  <span className="rounded-full border border-dark-gold bg-dark-gray-custom px-3 py-1 text-sm font-medium text-light-silver">
                    Cash on delivery
                  </span>
                )}
              </div>
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-sm font-medium ${
                      clothesdetails.stock > 10
                        ? "bg-dark-gold/30 text-gold border border-dark-gold"
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="border border-dark-gold rounded-lg px-3 py-2 bg-dark-gray-custom text-light-silver focus:outline-none focus:ring-2 focus:ring-gold"
                  >
              ...
              {reviews.length > 0 ? (
                <div className="space-y-6">
                  {reviews.map((review, index) => (
                    <div
                      key={review._id}
                      className="border border-dark-gold rounded-2xl p-4 sm:p-6 bg-dark-gray-custom/50 hover:shadow-xl transition-all duration-300 hover:border-gold relative overflow-hidden group"
                    >
                      {/* Review Header */}
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="ml-1 sm:ml-2 px-2 py-0.5 bg-dark-gold/30 text-gold rounded-full text-xs sm:text-sm font-bold">
                              {review.rating}.0
                            </span>
                          </div>
                        </div>
                        <div className="text-xs sm:text-sm text-light-silver font-medium bg-dark-gray-custom/50 px-3 py-1 rounded-full self-start sm:self-auto border border-dark-gold/50">
                      ...
                      {/* Review Index Badge */}
                      <div className="absolute -top-1 -right-1 w-12 h-12 bg-dark-gray-custom flex items-center justify-center rounded-bl-3xl text-dark-gold text-xl font-black group-hover:text-gold transition-colors duration-300 z-0 border border-dark-gold/50">
                        {index + 1}
                      </div>
                    </div>
                  ))}
                ...
                <div className="text-center py-16">
                  <div className="w-32 h-32 bg-dark-gray-custom rounded-full flex items-center justify-center mx-auto mb-6 relative">
                    <div className="absolute inset-0 bg-linear-to-br from-gold/20 to-dark-gold/20 rounded-full animate-pulse"></div>
                    <span className="text-6xl text-gold relative z-10">
                      <FaRegStar />
                    </span>
                  </div>
...
export default BestClothesDetails;
